...
class LegalController {
  public terms(req: Request, res: Response): void {
    res.type('html').send(
      renderPage(
        'Termos de Uso — PantherFitAI',
        `
  <h1>Termos de Uso — PantherFitAI</h1>
  <p>Estes Termos de Uso regem o uso da integração de publicação de conteúdo da PantherFitAI ("o Serviço"), uma ferramenta que permite publicar automaticamente fotos, vídeos e carrosséis nas contas de redes sociais (Instagram e TikTok) autorizadas pelo próprio titular da conta.</p>
  ...
  <p>O Serviço conecta-se às APIs oficiais do Instagram (Meta Graph API) e do TikTok (Content Posting API) para publicar, em nome do titular autorizado, conteúdo previamente definido por ele mesmo. O Serviço não publica conteúdo em contas de terceiros nem sem autorização explícita via OAuth.</p>
...
`,
  ...
  public privacy(req: Request, res: Response): void {
    res.type('html').send(
      renderPage(
        'Política de Privacidade — PantherFitAI',
        `
  <h1>Política de Privacidade — PantherFitAI</h1>
  <p>Esta Política de Privacidade explica como a integração de publicação de conteúdo da PantherFitAI ("o Serviço") trata dados ao se conectar com o Instagram e o TikTok em nome do titular da conta autorizada.</p>
  ...
  <ul>
    <li><strong>Tokens de acesso OAuth</strong> das contas de Instagram e TikTok autorizadas, usados exclusivamente para publicar conteúdo em nome do titular.</li>
  ...
  <p>O Serviço não coleta dados de outros usuários do Instagram ou do TikTok (seguidores, curtidas, comentários de terceiros etc.) além do necessário para confirmar que uma publicação foi concluída.</p>
  ...
  <p>Os dados são compartilhados apenas com as plataformas Meta (Instagram) e TikTok, na medida necessária para realizar a publicação — não vendemos, alugamos nem compartilhamos dados com nenhum outro terceiro.</p>
